...
export const userService = {
  ...
  createUser: async (data: {
    ...
    switch (tier) {
      case UserTier.STARTER:
        ...
        quota.remainingBroadcast = 10000;
        quota.trackingLimit = 350;
        quota.remainingTracking = 350;
        quota.contentLimit = 2500;
        quota.remainingContent = 2500;
        break;
      case UserTier.GROWTH:
        quota.broadcastLimit = 30000;
        quota.remainingBroadcast = 30000;
        quota.trackingLimit = 750;
        quota.remainingTracking = 750;
        quota.contentLimit = 5000;
        quota.remainingContent = 5000;
        break;
      case UserTier.SCALE:
        quota.broadcastLimit = 100000;
        quota.remainingBroadcast = 100000;
        quota.trackingLimit = 2500;
        quota.remainingTracking = 2500;
        quota.contentLimit = 15000;
        quota.remainingContent = 15000;
        break;
    }
  ...
  deleteUser: async (id: string) => {
    ...
    await BroadcastMessage.findOneAndDelete({
